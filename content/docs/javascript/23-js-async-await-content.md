...
בפרק הבא — **פרויקט מסכם ליחידת JavaScript**: מחברים יחד את כל מה שנלמד (פונקציות, מערכים, אובייקטים, closures, מודולים, ו-`async`/`await`) לכדי פרויקט אחד אמיתי — קטלוג ספרים שנטען מ-API חיצוני.
