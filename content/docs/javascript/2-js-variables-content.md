...
בפרק הבא נלמד על **Conditions & Loops** — תנאים (`if`/`else`) מריצים קטע קוד רק אם עומדים בתנאי מסוים; לולאות (`for`, `while`) מריצות אותו קטע קוד שוב ושוב. הבעיה שנפתרת: בלי תנאים, אי אפשר לקוד "להחליט" בין כמה אפשרויות; בלי לולאות, הדפסת 10
